...
{
    [Authorize]
    public class ShopBrandCommodityParameterSetController : CommunityControllerBase
    {
        readonly IHostingEnvironment hostingEnvironment;
        public ShopBrandCommodityParameterSetController(ICommunityService communityService
