...
using ZRui.Web.Core.Wechat.Open.MessageHandlers.OpenMessageHandler;
...
namespace ZRui.Web.Controllers
{
    ...
    public class WechatOpenController : Controller
    {
        ...
        public WechatOpenController(IHostingEnvironment hostingEnvironment, IOptions<WechatOpenOptions> wechatOpenOptions)
        {
