...
namespace ZRui.Web.Core.Wechat.Open.CustomMessageHandler
{
    /// <summary>
    /// 自定义MessageHandler
    ...
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        public CustomMessageHandler(Stream inputStream, PostModel postModel, string appId,string appSecret,IHostingEnvironment hostingEnvironment, int maxRecordCount = 0)
...
<a href=""http://sdk.weixin.senparc.com/FilterTest/Redirect"">点击这里</a>进行客户端约束测试（地址：http://sdk.weixin.senparc.com/FilterTest/Redirect），如果在微信外打开将重定向一次URL。";
                ...
                .Keyword("OPEN", () =>
                {
                    ...
                    openResponseMessage.Articles.Add(new Senparc.Weixin.MP.Entities.Article()
                    {
                        Title = "开放平台微信授权测试",
...
测试完成后，您可以登陆公众号后台取消授权。",
        ...
        public override IResponseMessageBase OnVoiceRequest(RequestMessageVoice requestMessage)
        {
            ...
            var uploadResult = Senparc.Weixin.MP.AdvancedAPIs.MediaApi.UploadTemporaryMedia(appId, UploadMediaFileType.image,
                                                         hostingEnvironment.MapPath("~/Images/Logo.jpg"));
        ...
        public override IResponseMessageBase OnVideoRequest(RequestMessageVideo requestMessage)
        {
            ...
            Task.Factory.StartNew(async () =>
             {
                 //上传素材
                 var dir = hostingEnvironment.MapPath("~/App_Data/TempVideo/");
